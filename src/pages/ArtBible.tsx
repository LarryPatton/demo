...
function ArtBible() {
  ...
  const styleList: StyleKey[] = ['stylizedFantasy', 'realistic', 'pixelArt', 'anime']
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${isActive 
                        ...
                        : 'border-[var(--border-default)] bg-[var(--bg-surface)] hover:border-[var(--border-emphasis)] hover:bg-[var(--bg-hover)]'
                      }
                    `}
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div className={`
                        ...
                        ${isActive ? 'bg-primary' : 'bg-[var(--bg-overlay)]'}
                      `}>
                        <Icon className={`w-5 h-5 ${isActive ? 'text-white' : 'text-[var(--text-secondary)]'}`} />
                      </div>
                      <div>
                        <h3 className={`text-sm font-semibold ${isActive ? 'text-[var(--primary-text)]' : 'text-[var(--text-primary)]'}`}>
                          {style.name}
                        </h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                {imageUrls.map((url, index) => (
                  <div 
                    ...
                    className="aspect-[4/3] bg-[var(--bg-overlay)] border border-[var(--border-muted)] rounded-lg overflow-hidden cursor-pointer hover:border-[var(--border-emphasis)] hover:scale-[1.02] transition-all group relative"
                  >
